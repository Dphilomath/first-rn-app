...
import { StyleSheet, Button, TextInput, Text, View, ScrollView, FlatList, renderItem, SafeAreaView } from "react-native";
import './UserAgent'
...
function Chatpage({route, navigation}){
    ...
    return(
        <View style={{flex:1}}>
            ...
            <Text>Key: <Text onPress={()=>styles.key={display:"flex"}}>{key}</Text></Text>
            <View style={{flex:0.9}}>
